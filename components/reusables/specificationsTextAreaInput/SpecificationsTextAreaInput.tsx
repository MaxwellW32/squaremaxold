...
export default function SpecificationsTextAreaInput({ name, value, onInput, label, id, errors, errorColor = "#ff6c87", onBlur, placeHolder, isOptionalText, rows, ...elProps }: { name: string, value: string, onInput: (e: React.FormEvent<HTMLTextAreaElement>) => void, onBlur?: (e: React.FocusEvent<HTMLTextAreaElement, Element>) => void, label?: string, id?: string, errors?: string, errorColor?: string, placeHolder?: string, isOptionalText?: string, rows?: number } & React.HTMLAttributes<HTMLDivElement>) {
    return (
        <div {...elProps}>
